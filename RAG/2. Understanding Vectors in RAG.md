...
---
 you like me to also **add a Jupyter notebook example** (step-by-step vector creation + retrieval demo) so learners can run it directly in your repo? That would make it hands-on and interactive.
